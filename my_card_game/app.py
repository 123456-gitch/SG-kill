...
def equip_status_logic(idx, status_card):
    ...
    p['status_cooldown'] = 3
    add_log(f"⚡ 【{p['name']}】装备【{status_card}】，持续3回合后可更换")
